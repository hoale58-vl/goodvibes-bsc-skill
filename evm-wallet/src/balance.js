...
Examples:
  node src/balance.js bsc                            # BNB balance on BSC
  node src/balance.js bsc 0x8AC76a51cc950d98...      # USDC balance on BSC
  node src/balance.js --all                          # All chains, native tokens
      ...
      if (jsonFlag) {
        ...
        if (result.success) {
          ...
          if (!hasBalance) {
            ...
            if (result.chain === 'opbnb') {
              console.log('   opBNB has the lowest fees for testing.');
            }
          }
        } else {
