...
Examples:
  ...
  node src/contract.js bsc 0x8AC76a51c... "balanceOf(address)" 0x123...
  node src/contract.js bsc 0x123... "symbol()"
  
  # Write operations (state-changing functions)
  node src/contract.js bsc 0x8AC76a51c... "transfer(address,uint256)" 0x123... 1000000
  node src/contract.js opbnb 0x456... "approve(address,uint256)" 0x123... 1000000000 --yes
  
  # Payable functions
  node src/contract.js bsc 0x789... "deposit()" --value 0.1
  node src/contract.js opbnb 0x456... "mint(address)" 0x123... --value 0.01 --yes
`);
}
