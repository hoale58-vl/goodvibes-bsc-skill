...
async function main() {
  try {
    ...
    if (jsonFlag) {
      ...
      console.log('\nNext steps:');
      console.log('1. Fund your wallet by sending BNB to the address above');
      console.log('2. Check balance: node src/balance.js bsc');
      console.log('3. Start with small amounts on opBNB (lowest gas fees)');
    }
